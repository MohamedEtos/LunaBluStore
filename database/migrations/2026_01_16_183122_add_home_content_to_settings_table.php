...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('settings', function (Blueprint $table) {
            ...
            $table->string('slider1_caption')->nullable()->default('طرحتك… لمستك الخاصة كل يوم');
            ...
            $table->string('slider2_title')->nullable()->default('تفرّدي بستايلك: طرح حصرية تكسر حاجز المألوف.');
