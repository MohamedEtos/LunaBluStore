        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route('dashboard') }}">
                        ...
                        <h2 class="brand-text mb-0">LunaBlu</h2>
                    </a></li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a href="index.html"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span><span class="badge badge badge-warning badge-pill float-right mr-2">2</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a href="{{ route('dashboard') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="eCommerce">الرئيسية</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" navigation-header"><span>المنتجات</span>
                </li>
                <li class=" nav-item"><a href="{{ route('productList') }}"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="product">المنتجات</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="{{ route('fabricList') }}"><i class="feather icon-check-square"></i><span class="menu-title" data-i18n="Todo">انواع القماش</span></a>
                </li>
                <li class=" nav-item"><a href="{{ route('setting') }}"><i class="feather icon-settings"></i><span class="menu-title" data-i18n="Settings">اعدادات الموقع</span></a>
                </li>
                <li class=" nav-item"><a href=""><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Calender">Calender</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="menu-content">
                        <li><a href="admin/starter-kit/rtl/vertical-menu-template/sk-layout-2-columns.html"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="2 columns">2 columns</span></a>
                        </li>
                        <li><a href="admin/starter-kit/rtl/vertical-menu-template/sk-layout-fixed-navbar.html"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Fixed navbar">Fixed navbar</span></a>
                        </li>
                        <li><a href="admin/starter-kit/rtl/vertical-menu-template/sk-layout-floating-navbar.html"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Floating navbar">Floating navbar</span></a>
                        </li>
                        <li><a href="admin/starter-kit/rtl/vertical-menu-template/sk-layout-fixed.html"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Fixed layout">Fixed layout</span></a>
                        </li>
                    </ul>
                </li>
